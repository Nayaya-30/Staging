...
import PreviewSection from "@/components/waitlist/sections/PreviewSection";
import CountdownSection from "@/components/waitlist/sections/CountdownSection";
...
export default function WaitlistPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-inter">
      ...
      <PreviewSection />
      <CountdownSection launchDate={launchDate} />
      <Benefits />
      <Features />
